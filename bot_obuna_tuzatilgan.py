...
def check_subscription(user_id: int) -> tuple:
    # Adminlar uchun majburiy obuna umuman tekshirilmaydi.
    # Instagram ham hech qachon obuna sharti sifatida tekshirilmaydi.
    if is_admin(user_id):
        return True, []
...
def get_subscription_keyboard(channels: list) -> InlineKeyboardMarkup:
    ...
    # Bu tugma faqat Telegram kanal(lar)ini tekshiradi. Instagram
    # yuqorida faqat havola sifatida ko'rsatiladi va tekshirilmaydi.
    keyboard.add(InlineKeyboardButton("✅ A'zo bo'ldim / Tekshirish", callback_data="check_subscription"))
    return keyboard
...
def start_handler(message):
    ...
    # Admin bo'lsa majburiy obuna oynasi ko'rsatilmaydi.
